...
public class JedisUtilTest {
	...
	@Before
	public void setUp() {
		pool = new JedisPool(new JedisPoolConfig(), "10.0.53.19",9000);
//		pool = new JedisPool(new JedisPoolConfig(), "10.0.55.118",7000);
	...
	@Test
	public void testGet() {
		System.out.println(jedis.get("api_id:251aefc8207945309ac9c2272b37df47version:1.0"));
	}
