...
package com.personal.springboot.shiro.utils;
...
public class ReturnUtil {
    ...
    public static ModelMap Success(String msg, Object obj, String referer) {
        msg = StringUtils.isBlank(msg) || StringUtils.isBlank(msg) ? "操作成功" : msg;
    ...
    public static ModelMap Error(String msg, Object obj, String referer) {
        msg = StringUtils.isBlank(msg) || StringUtils.isBlank(msg) ? "操作失败" : msg;
        ModelMap mp = new ModelMap();
        mp.put("status", 0);
        mp.put("state", "error");
        mp.put("msg", msg);
