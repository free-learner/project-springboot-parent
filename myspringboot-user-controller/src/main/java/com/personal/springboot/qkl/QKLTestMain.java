package com.personal.springboot.qkl;
 ...
 * @Date 2018年11月2日
 */
public class QKLTestMain implements HandlerCallback {
...
//        test.testQueryByDate();
    ...
    public void testInsert(String data) throws Exception {
        ...
        FabricClient.insert(data, map,new QKLTestMain());
    }
    ...
    public void testQueryByDate(String date) throws Exception {
        ...
        map.put("date",date);
        FabricClient.queryByDate(map,new QKLTestMain());
    }
    ...
    public void testQueryById() throws Exception {
        ...
        map.put("flag","5");
        FabricClient.queryById(map,new QKLTestMain());
    }
