 ...
 * @Date 2018年11月2日
 */
public class TestMain2 implements HandlerCallback {
    private static final Logger LOGGER = LoggerFactory.getLogger(TestMain2.class);
...
//        test.testQueryByDate();
    ...
    public void testInsert(String data) throws Exception {
        ...
        FabricClient.insert(data, map,new TestMain2());
    }
    ...
    public void testQueryByDate(String date) throws Exception {
        ...
        map.put("date",date);
        FabricClient.queryByDate(map,new TestMain2());
    }
    ...
    public void testQueryById() throws Exception {
        ...
        map.put("flag","5");
        FabricClient.queryById(map,new TestMain2());
    }
    
    @Override
    public void back(String s) {
        System.out.println("成功返回时的结果"+s);
        LOGGER.info("数据操作结果:{}" , s);
    }
