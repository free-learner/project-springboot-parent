 ...
 */
public class MyDayRollingFileAppender extends FileAppender {
     ...
     */
    public MyDayRollingFileAppender() {
    }

    /**
     * 改造过的构造器
     */
    public MyDayRollingFileAppender(Layout layout, String filename, int maxBackupIndex) throws IOException {
     ...
     * 2.if需要更新，当前文件rename到文件名+日期， 重新开始写文件 3.
