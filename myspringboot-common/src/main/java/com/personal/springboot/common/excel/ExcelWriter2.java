...
public class ExcelWriter2 {
    private static final Logger LOGGER = LoggerFactory.getLogger(ExcelWriter2.class);
    ...
    // 行信息内容样式
     private static XSSFCellStyle contentStyle = null;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ExcelWriter2.writeExcel2007(titleStrs, contentList, filename,sheetName,filePath);
    ...
    public static void writeExcel2007(String[] titleStrs, List<String[]> contentList,String filename,String sheetName,String filePath) throws IOException {
        if(StringUtils.isBlank(filePath)){
            filePath=ExcelWriter2.filePath;
        }
...
//         sheet.addMergedRegion(new CellRangeAddress(0, 0, 0, titleCount-1));  
        ...
        for (int k = 0; k < titleCount; k++) {
             XSSFCell cell = titleRow.createCell((short) k); 
             // 设置标题样式
     ...
     * 样式初始化设置
     */
    private static void setXSSFExcelStyle(XSSFWorkbook workBook) {
        // 设置列标题字体，样式
      ...
      //设置背景色
        ...
        // 内容列样式
        XSSFFont contentStyleFont = workBook.createFont();
